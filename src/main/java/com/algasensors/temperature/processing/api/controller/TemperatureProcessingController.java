...
import com.algasensors.temperature.processing.api.model.TemperatureLogResponseDTO;
...
public class TemperatureProcessingController {
    ...
    public void data(@PathVariable TSID sensorId, @RequestBody String input) {
        ...
        TemperatureLogResponseDTO logOutput = TemperatureLogResponseDTO.builder()
